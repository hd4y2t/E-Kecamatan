                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card bg-light">
                            <form method="post" action="<?= base_url('pelayanan_umum/buatSurat/') . $m['id'] ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <tr>
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="tgl_pengantar" name="tgl_pengantar" placeholder="Tanggal">
                                        </div>
                                    </tr>
                                    <tr>
                                        <div class="form-group">
