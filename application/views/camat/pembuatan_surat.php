                                                    ...
                                                    <?php foreach ($ps as $s) : ?>
                                                        <tr>
                                                            ...
                                                            <?php if ($s['status_surat'] <= 1) { ?>
                                                                <td>
                                                                    <button class="btn btn-simple btn-warning btn-sm" data-toggle="modal" data-target="#lihatSurat<?= $s['no_surat']; ?>">Buat Surat</button>
                                                                </td>
                                                            ...
                                                            ?>
                                                                <td>
                                                                    <a href="<?= base_url('camat/cetak_skm/') . $s['no_surat'] ?>" class="btn btn-simple btn-success btn-sm text-light"><i class="material-icons"> download </i>
                                                                    </a>
                                                                </td>
                                                            <?php
                                                            }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="instruction">
                        <div class="row">
                            <div class="col-md">
                                <embed type="application/pdf" width="100%" height="550px;" src="<?= base_url('camat/cetak_skm/') . $s['no_surat'] ?>"></embed>
                            </div>
                    ...
                    <tbody>
                        <tr>
                            <div class="content-left">
                                <td>
                                    <a class="btn btn-success" href="<?= base_url("camat/terima/") . $s['no_surat'] ?>">Terima</a>
                                </td>
                            </div>
                            </td>
                        </tr>
