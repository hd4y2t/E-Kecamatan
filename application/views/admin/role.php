                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($role as $r) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $r['role']; ?></td>
                                                        <td>
                                                            <a href="<?= base_url('admin/role_akses/') . $r['id']; ?>" class="btn btn-warning">akses </a>
                                                            <a href="" class="btn btn-primary">edit </a>
                                                            <a href="<?= base_url(); ?>admin/delete_role/<?= $r['id']; ?>" onclick="return confirm('yakin?');" class="btn btn-danger"> <i class="material-icons">delete</i> </a>
