                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($surat_keluar as $s) : ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button class="btn btn-simple btn-success btn-icon btn-sm" data-toggle="modal" data-target="#statusPengajuan<?= $s['id']; ?>"><i class="material-icons">outbond</i>Terima</button>
                                                                <button class="btn btn-simple btn-danger btn-icon btn-sm" data-toggle="modal" data-target="#statusPengajuan<?= $s['id']; ?>"><i class="material-icons">close</i>tolak</button>
