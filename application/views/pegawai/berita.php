                    ...
                    <div class="container-fluid">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="" class="btn btn-success" data-toggle="modal" data-target="#newsuratModal">Tambah Berita</a>
                                <div class="row">
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($berita as $s) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $s['excerpt']; ?></td>
                                                        <td><?= $s['created_at']; ?></td>
                                                        <td><img src="<?= base_url('upload/berita/') . $s['foto'] ?>" class="img-thumbnail" style="height: 200px; width:200px;"></td>
                                                        <td>
                                                            <a href="<?= base_url('pegawai/edit_berita/') . $s['id_berita']; ?>" class="btn btn-warning btn-sm"><i class="material-icons">edit</i> </a>
